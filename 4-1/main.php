<?php
    ...
    try {
        $sql = "INSERT INTO posts (title, content) VALUES ('今日はぽかぽか', '春が来ましたね〜！')";
        $sql = "INSERT INTO posts (title, content) VALUES ('美味しいお店発見', '今日はお休みだったので都内をブラブラしていました。そしてぶらっと立ち寄ったカツ丼のお店がこれまたおいしくて安い！また行こう！')";
